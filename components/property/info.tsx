	...
	return (
		<View style={styles.container}>
			<View style={styles.infoItems}>
				<PropertyInfoItem data={property?.sqft} text="sqft" icon="cash-outline" />
				<PropertyInfoItem
				...
				<View style={styles.agentContainer}>
					<View style={styles.agentContainerLeft}>
						...
						<View style={styles.agentContainerRight}>
							...
							<Text style={styles.agentRelation}>
								{property?.agent.type}
							</Text>
						</View>
					</View>
			...
			<View>
				...
				<GridList
					...
					renderItem={(item) => (
						<PropertyInfoItem icon={item.image} text={item.label} />
					)}
				...
				<View>
					...
					<Pressable onPress={handleOpenMap}>
						<Image
							...
							source={{
								uri: `https://maps.googleapis.com/maps/api/staticmap?center=${property?.location.lat},${property?.location.lng}&zoom=17&size=600x300&markers=color:red%7C${property?.location.lat},${property?.location.lng}&key=${config.googleApiKey}`,
							}}
						/>
					</Pressable>
				</View>
