        ...
        <View>
          ...
          <Pressable onPress={handleOpenMap}>
            <Image
              ...
              source={{
                uri: `https://maps.googleapis.com/maps/api/staticmap?center=${property?.location.lat},${property?.location.lng}&zoom=17&size=600x300&markers=color:red%7C${property?.location.lat},${property?.location.lng}&key=${keys.googleApiKey}`
              }}
            />
          </Pressable>
        </View>
